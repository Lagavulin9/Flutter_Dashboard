...
*/
#ifndef V0_COMMONAPI_CAR_INFO_HPP_
#define V0_COMMONAPI_CAR_INFO_HPP_
...
const char* CarInfo::getInterface() {
    return ("commonapi.CarInfo:v0_1");
}

CommonAPI::Version CarInfo::getInterfaceVersion() {
...
#endif // V0_COMMONAPI_CAR_INFO_HPP_
